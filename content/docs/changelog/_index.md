...
- **Düzeltilen** (Fixed) - Hata düzeltmeleri
- **Kaldırılan** (Removed) - Kaldırılan özellikler
- **Güvenlik** (Security) - Güvenlik yamalarıve güncellemeleri
...
_Detaylı değişiklik bilgileri için ilgili tarihlerin sayfalarını ziyaret edebilirsiniz._
